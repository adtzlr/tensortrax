<p align="center">
  <img src="https://github.com/adtzlr/tensortrax/assets/5793153/6a69a617-6adf-4cf0-aaeb-a8d4fd88faab" height="65px"/>
...
> [!NOTE]  
> Contrary to NumPy's `w, v = np.linalg.eigh(C)`, which returns eigenvalues and -vectors, the differentiable `w, M = tm.linalg.eigh(C)` function returns eigenvalues and eigen**bases** of symmetric real-valued tensors.
